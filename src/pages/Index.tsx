      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            { title: "Brand Positioning", icon: Palette, color: "blue" as const, description: "Workforce development ecosystem for the modern economy", items: ["Integrated approach across education, training, and employment", "Scalable systems for talent development", "Focus on adaptability and real-world readiness", "Strong emphasis on people, culture, and connection"] },
